...
void ActionSelector::addAction(IAction &action){
    auto actionButton = std::make_shared<Button>(ui, sf::Color{255,100,100,100}, sf::Color{100,100,100,100}, 
    ...
    actionButton->onClickCallback = std::make_shared<EventCallback<IAction>>(&action, &IAction::triggerAction);
    actionButtons.push_back(actionButton);
    addChild(actionButton);

    auto actionSprite = std::make_shared<sf::Sprite>();
